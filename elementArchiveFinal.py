...
#Period is the x axis on the periodic table and determines the number of horns each element dragon has
        # this ended up not being necessary since the horns are directly coded in the element retrieval section
...
#Dragon class assigns the element name of the dragon
class Dragon:
...
# %%
        ...
        # Create Group instances for each element by assigning them as attributes
...
#5 second timer to print the hint while waiting for an input
...
while True:
        element = input("Enter the element name, symbol, or atomic number, or type 'exit' to quit: ")        
...
#it is very long. Beneath it is the else input and the timer cancellation
        ...
        if element == "hydrogen" or element == "Hydrogen" or element == "H" or element == "1":
                ...
                Cs = Dragon("Cesium")                   # <-- My favourite element :)
